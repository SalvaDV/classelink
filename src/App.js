  ...
  return(
    <div>
      <button onClick={pagar} disabled={estado==="loading"}
        ...
        {estado==="loading"?(
          <><span style={{fontSize:14,animation:"spin .8s linear infinite",display:"inline-block"}}>⟳</span> Iniciando pago…</>
        ):(
          <>
            {/* Logo MP simplificado */}
            <svg width="20" height="14" viewBox="0 0 52 36" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect width="52" height="36" rx="4" fill="white" fillOpacity="0.15"/>
              <circle cx="18" cy="18" r="10" fill="white" fillOpacity="0.9"/>
              <circle cx="34" cy="18" r="10" fill="white" fillOpacity="0.6"/>
            </svg>
