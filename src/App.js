      ...
      <div style={{marginTop:8}}>
        ...
        <div style={{display:"flex",flexDirection:"column",gap:8}}>
          {[
            ...
            {v:"dependencia",icon:"👔",title:"Relación de dependencia",sub:"Trabajás en relación de dependencia"},
            {v:"no_inscripto",icon:"🙋",title:"No estoy inscripto",sub:"No tengo inscripción fiscal activa"},
            {v:"exento",icon:"✋",title:"Exento / Otro",sub:"Otro régimen o situación especial"},
          ].map(({v,icon,title,sub:s})=>(
