...
function DocBadge({avgUser,countPub,post}){
  ...
  if(esNuevo)return<span style={{fontSize:10,fontWeight:700,padding:"2px 7px",borderRadius:20,background:"#2EC4A012",color:"#0F6E56",border:"1px solid #2EC4A040",whiteSpace:"nowrap"}}>🆕 Nuevo</span>;
  return null;
}
...
function BusquedaIA({onBuscar,iaLoading,onClose}){
  ...
  const historial=sb.getBusquedasRecientes?[]:[]; // se carga abajo
