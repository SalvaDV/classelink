      ...
      <div style={{flex:1,maxWidth:900,margin:"0 auto",width:"100%",padding:"0 0 100px"}}>
        ...
        <div style={{display:"flex",gap:32,alignItems:"flex-start",padding:"0 20px",flexWrap:"wrap"}}>
          ...
          <div style={{flex:"1 1 340px",minWidth:0}}>
            ...
            {/* ── Publicaciones relacionadas (estilo ML "También te puede interesar") ── */}
            <RelacionadasSection post={post} session={session} onOpenDetail={(p)=>{onClose();setTimeout(()=>onOpenDetail&&onOpenDetail(p),80);}} onOpenDetail2={onOpenDetail}/>
          </div>
