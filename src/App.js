...
function ExplorePage({session,onOpenChat,onOpenDetail,onOpenPerfil,onOpenCurso}){
  ...
  return(<>
    <div style={{fontFamily:FONT}}>
      ...
      {/* ── DRAWER DE FILTROS (overlay, no empuja contenido) ── */}
      {panelOpen&&(
        <>
          {/* Overlay oscuro */}
          ...
          <div style={{position:"fixed",top:0,right:0,bottom:0,width:"min(320px,90vw)",background:C.surface,zIndex:151,boxShadow:"-4px 0 24px rgba(0,0,0,.12)",overflowY:"auto",WebkitOverflowScrolling:"touch",animation:"slideInRight .2s ease",display:"flex",flexDirection:"column",fontFamily:FONT}}>
            ...
            <div style={{padding:"16px 20px",flex:1}}>
              ...
              <div style={{marginBottom:16}}><FL ch="Ubicación"/>
                <input value={filtroUbicacion} onChange={e=>setFiltroUbicacion(e.target.value)} placeholder="Ej: Palermo, CABA" style={{width:"100%",background:C.bg,border:`1px solid ${filtroUbicacion?C.accent:C.border}`,borderRadius:8,padding:"9px 12px",color:C.text,fontSize:14,outline:"none",fontFamily:FONT,boxSizing:"border-box"}}/>
            ...
            <div style={{padding:"14px 20px",borderTop:`1px solid ${C.border}`,position:"sticky",bottom:0,background:C.surface}}>
              <button onClick={()=>setPanelOpen(false)} style={{width:"100%",background:LUD.grad,border:"none",borderRadius:20,color:"#fff",padding:"13px",fontWeight:600,fontSize:14,cursor:"pointer",fontFamily:FONT,boxShadow:"0 4px 14px rgba(26,110,216,.3)"}}>
