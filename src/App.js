...
function OnboardingModal({session,onClose}){
     ...
     body:(
      <div style={{display:"flex",flexDirection:"column",gap:12,marginTop:8}}>
        ...
        <div>
          ...
          <div style={{display:"flex",flexWrap:"wrap",gap:6}}>
            {[["aprender_nuevo","🌱 Aprender algo nuevo"],["mejorar","📈 Mejorar habilidades"],["certificar","🏅 Obtener certificado"],["ensenar","🧑‍🏫 Enseñar lo que sé"]].map(([v,l])=>(
  ...
  const PASOS_KYC=[
    ...
    {id:"kyc_identidad",title:"Verificación de identidad",sub:"Requerida para publicar clases en Luderis.",
     canNext:dni.trim().length>=7&&!!fechaNac,
     body:(
      <div style={{display:"flex",flexDirection:"column",gap:12,marginTop:8}}>
        ...
        <div>
          ...
          <div style={{fontSize:11,color:C.muted,marginTop:4}}>Debés ser mayor de 18 años para publicar clases.</div>
        </div>
      </div>
    )},
      ...
      <div style={{display:"flex",flexDirection:"column",gap:14,marginTop:8}}>
        ...
        <div onClick={()=>setTerminosAceptados(v=>!v)}
          ...
          <div style={{fontSize:12,color:C.muted,lineHeight:1.6}}>
            Acepto los <span style={{color:C.accent,fontWeight:600}}>Términos y Condiciones</span> y la <span style={{color:C.accent,fontWeight:600}}>Política de Privacidad</span> de Luderis. Declaro que la información proporcionada es verídica y completa.
          </div>
        </div>
      </div>
    )},
