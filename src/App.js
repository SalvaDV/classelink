...
function ContraRespondedor({oferta,session,onActualizado}){
  ...
  return(
    <>
      ...
      <span onClick={()=>setPopup(true)} style={{fontSize:10,fontWeight:700,color:"#C85CE0",background:"#C85CE015",border:"1px solid #C85CE033",borderRadius:20,padding:"3px 10px",cursor:"pointer",flexShrink:0,alignSelf:"center",whiteSpace:"nowrap"}}>
        ↔ Ver contraoferta
      </span>
